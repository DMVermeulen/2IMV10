...
void main() {
    ...
    if (globalID < totalSize) {	
        int id0 = 2*globalID;
        int id1 = id0+1;		
		vec3 point0 = vec3(relaxedTubesData[id0*3],relaxedTubesData[id0*3+1],relaxedTubesData[id0*3+2]);
        vec3 point1 = vec3(relaxedTubesData[id1*3],relaxedTubesData[id1*3+1],relaxedTubesData[id1*3+2]);
